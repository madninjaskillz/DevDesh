...
export type ThemeName = 'redgate' | 'glass' | 'metro' | 'fluent' | 'win95' | 'winxp' | 'macos9' | 'aqua' | 'vista' | 'cyberpunk' | 'nord' | 'dracula' | 'solarized' | 'catppuccin' | 'synthwave' | 'terminal' | 'amiga' | 'beos' | 'ubuntu' | 'ios' | 'android' | 'chromeos' | 'nextstep' | 'os2' | 'irix' | 'palmos' | 'c64' | 'msdos' | 'carbon' | 'hig' | 'ant' | 'gruvbox' | 'monokai' | 'onedark' | 'win31' | 'gnome' | 'sonoma' | 'highcontrast' | 'paper' | 'vaporwave' | 'tos' | 'templeos' | 'haiku' | 'plan9' | 'solaris' | 'win10' | 'kde' | 'mint' | 'redhat' | 'zxspectrum' | 'atari' | 'symbian' | 'tokyonight' | 'everforest' | 'rosepine' | 'kanagawa' | 'ayu' | 'retrowave' | 'cottagecore' | 'brutalist' | 'riscos' | 'webos' | 'windowsphone' | 'blackberry' | 'tizen' | 'sailfish' | 'openstep' | 'morphos' | 'reactos' | 'hpux' | 'material' | 'nightowl' | 'vitesse' | 'palenight' | 'cobalt' | 'solarpunk' | 'y2k' | 'noir' | 'pastel' | 'steampunk';
...
// === 41. STAR TREK TOS / LCARS ===
const tosLight = createTheme({ palette: { mode: 'dark', primary: { main: '#FF9900' }, secondary: { main: '#CC6699' }, error: { main: '#CC0000' }, warning: { main: '#FF9900' }, success: { main: '#99CC00' }, background: { default: '#000000', paper: '#1A1A2E' }, text: { primary: '#FF9900', secondary: '#9999CC' } }, typography: { fontFamily: '"Michroma", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 600 } }, shape: { borderRadius: 16 }, components: baseComponents });
const tosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FF9900' }, secondary: { main: '#CC6699' }, error: { main: '#CC0000' }, warning: { main: '#FF9900' }, success: { main: '#99CC00' }, background: { default: '#000000', paper: '#0D0D1A' }, text: { primary: '#FF9900', secondary: '#6688CC' } }, typography: { fontFamily: '"Michroma", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 600 } }, shape: { borderRadius: 16 }, components: baseComponents });

// === 42. TEMPLEOS ===
const templeosLight = createTheme({ palette: { mode: 'dark', primary: { main: '#FFFFFF' }, secondary: { main: '#AAAAAA' }, error: { main: '#FF5555' }, warning: { main: '#FFFF55' }, success: { main: '#55FF55' }, background: { default: '#0000AA', paper: '#0000AA' }, text: { primary: '#FFFFFF', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Courier New", "Fixedsys Excelsior", monospace', fontSize: 14, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });
const templeosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FFFFFF' }, secondary: { main: '#AAAAAA' }, error: { main: '#FF5555' }, warning: { main: '#FFFF55' }, success: { main: '#55FF55' }, background: { default: '#0000AA', paper: '#000088' }, text: { primary: '#FFFFFF', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Courier New", "Fixedsys Excelsior", monospace', fontSize: 14, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 43. HAIKU ===
const haikuLight = createTheme({ palette: { mode: 'light', primary: { main: '#3B7AB8' }, secondary: { main: '#FFD700' }, error: { main: '#CC3333' }, warning: { main: '#E6A800' }, success: { main: '#339933' }, background: { default: '#D8D8D8', paper: '#ECECEC' }, text: { primary: '#222222', secondary: '#555555' } }, typography: { fontFamily: '"Noto Sans", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });
const haikuDark = createTheme({ palette: { mode: 'dark', primary: { main: '#5B9AD8' }, secondary: { main: '#FFD700' }, error: { main: '#FF5555' }, warning: { main: '#FFD700' }, success: { main: '#55BB55' }, background: { default: '#2A2A2A', paper: '#3A3A3A' }, text: { primary: '#D8D8D8', secondary: '#999999' } }, typography: { fontFamily: '"Noto Sans", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });

// === 44. PLAN 9 ===
const plan9Light = createTheme({ palette: { mode: 'light', primary: { main: '#7777CC' }, secondary: { main: '#448844' }, error: { main: '#CC4444' }, warning: { main: '#AAAA44' }, success: { main: '#44AA44' }, background: { default: '#EAFFEA', paper: '#FFFFEA' }, text: { primary: '#000000', secondary: '#444444' } }, typography: { fontFamily: '"Lucida Console", "Courier New", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });
const plan9Dark = createTheme({ palette: { mode: 'dark', primary: { main: '#9999EE' }, secondary: { main: '#66AA66' }, error: { main: '#EE6666' }, warning: { main: '#CCCC66' }, success: { main: '#66CC66' }, background: { default: '#2A3A2A', paper: '#3A3A2A' }, text: { primary: '#EAFFEA', secondary: '#AABBAA' } }, typography: { fontFamily: '"Lucida Console", "Courier New", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 45. SOLARIS CDE ===
const solarisLight = createTheme({ palette: { mode: 'light', primary: { main: '#4B348B' }, secondary: { main: '#006699' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#AEB2C3', paper: '#C8CCD8' }, text: { primary: '#1A1A2E', secondary: '#444466' } }, typography: { fontFamily: '"Helvetica", "Roboto", Arial, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });
const solarisDark = createTheme({ palette: { mode: 'dark', primary: { main: '#7B5BBB' }, secondary: { main: '#3399CC' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#2A2A3E', paper: '#3A3A50' }, text: { primary: '#C8CCD8', secondary: '#8888AA' } }, typography: { fontFamily: '"Helvetica", "Roboto", Arial, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });

// === 46. WINDOWS 10 ===
const win10Light = createTheme({ palette: { mode: 'light', primary: { main: '#0078D7' }, secondary: { main: '#666666' }, error: { main: '#E81123' }, warning: { main: '#FF8C00' }, success: { main: '#107C10' }, background: { default: '#F3F3F3', paper: '#FFFFFF' }, text: { primary: '#000000', secondary: '#555555' } }, typography: { fontFamily: '"Segoe UI", "Roboto", Arial, sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });
const win10Dark = createTheme({ palette: { mode: 'dark', primary: { main: '#0078D7' }, secondary: { main: '#888888' }, error: { main: '#E81123' }, warning: { main: '#FF8C00' }, success: { main: '#107C10' }, background: { default: '#001524', paper: '#1C1C1C' }, text: { primary: '#FFFFFF', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Segoe UI", "Roboto", Arial, sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });

// === 47. KDE PLASMA ===
const kdeLight = createTheme({ palette: { mode: 'light', primary: { main: '#3DAEE9' }, secondary: { main: '#7B68EE' }, error: { main: '#DA4453' }, warning: { main: '#F67400' }, success: { main: '#27AE60' }, background: { default: '#EFF0F1', paper: '#FCFCFC' }, text: { primary: '#232629', secondary: '#7F8C8D' } }, typography: { fontFamily: '"Noto Sans", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });
const kdeDark = createTheme({ palette: { mode: 'dark', primary: { main: '#3DAEE9' }, secondary: { main: '#7B68EE' }, error: { main: '#DA4453' }, warning: { main: '#F67400' }, success: { main: '#27AE60' }, background: { default: '#232629', paper: '#31363B' }, text: { primary: '#EFF0F1', secondary: '#7F8C8D' } }, typography: { fontFamily: '"Noto Sans", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });

// === 48. LINUX MINT ===
const mintLight = createTheme({ palette: { mode: 'light', primary: { main: '#87CF3E' }, secondary: { main: '#2B5329' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#CCCCCC', paper: '#E8E8E8' }, text: { primary: '#333333', secondary: '#666666' } }, typography: { fontFamily: '"Ubuntu", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });
const mintDark = createTheme({ palette: { mode: 'dark', primary: { main: '#87CF3E' }, secondary: { main: '#5B9B5B' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#2B2B2B', paper: '#3B3B3B' }, text: { primary: '#D8D8D8', secondary: '#999999' } }, typography: { fontFamily: '"Ubuntu", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });

// === 49. RED HAT ===
const redhatLight = createTheme({ palette: { mode: 'light', primary: { main: '#EE0000' }, secondary: { main: '#0066CC' }, error: { main: '#CC0000' }, warning: { main: '#F0AB00' }, success: { main: '#3E8635' }, background: { default: '#F0F0F0', paper: '#FFFFFF' }, text: { primary: '#21272D', secondary: '#6A6E73' } }, typography: { fontFamily: '"Red Hat Display", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });
const redhatDark = createTheme({ palette: { mode: 'dark', primary: { main: '#EE0000' }, secondary: { main: '#4394E5' }, error: { main: '#EE0000' }, warning: { main: '#F0AB00' }, success: { main: '#3E8635' }, background: { default: '#21272D', paper: '#2B3137' }, text: { primary: '#E8E8E8', secondary: '#8A8D91' } }, typography: { fontFamily: '"Red Hat Display", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });

// === 50. ZX SPECTRUM ===
const zxspectrumLight = createTheme({ palette: { mode: 'dark', primary: { main: '#00FF00' }, secondary: { main: '#FF00FF' }, error: { main: '#FF0000' }, warning: { main: '#FFFF00' }, success: { main: '#00FF00' }, background: { default: '#000000', paper: '#1A1A1A' }, text: { primary: '#FFFFFF', secondary: '#00FFFF' } }, typography: { fontFamily: '"Courier New", "Press Start 2P", monospace', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });
const zxspectrumDark = createTheme({ palette: { mode: 'dark', primary: { main: '#00FF00' }, secondary: { main: '#FF00FF' }, error: { main: '#FF0000' }, warning: { main: '#FFFF00' }, success: { main: '#00FF00' }, background: { default: '#000000', paper: '#111111' }, text: { primary: '#FFFFFF', secondary: '#00FFFF' } }, typography: { fontFamily: '"Courier New", "Press Start 2P", monospace', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 51. ATARI ST GEM ===
const atariLight = createTheme({ palette: { mode: 'light', primary: { main: '#00AA00' }, secondary: { main: '#000000' }, error: { main: '#CC0000' }, warning: { main: '#CCAA00' }, success: { main: '#00AA00' }, background: { default: '#FFFFFF', paper: '#E8E8E8' }, text: { primary: '#000000', secondary: '#444444' } }, typography: { fontFamily: '"Courier New", monospace', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });
const atariDark = createTheme({ palette: { mode: 'dark', primary: { main: '#00CC00' }, secondary: { main: '#AAAAAA' }, error: { main: '#FF4444' }, warning: { main: '#EEDD44' }, success: { main: '#00CC00' }, background: { default: '#1A1A1A', paper: '#2A2A2A' }, text: { primary: '#E8E8E8', secondary: '#888888' } }, typography: { fontFamily: '"Courier New", monospace', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700 }, button: { fontWeight: 700 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 52. SYMBIAN ===
const symbianLight = createTheme({ palette: { mode: 'light', primary: { main: '#005BAD' }, secondary: { main: '#C0C0C0' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#E8E8E8', paper: '#F5F5F5' }, text: { primary: '#222222', secondary: '#666666' } }, typography: { fontFamily: '"Nokia Pure", "Helvetica Neue", "Roboto", sans-serif', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });
const symbianDark = createTheme({ palette: { mode: 'dark', primary: { main: '#3388CC' }, secondary: { main: '#888888' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#1A1A2E', paper: '#2A2A3E' }, text: { primary: '#E8E8E8', secondary: '#999999' } }, typography: { fontFamily: '"Nokia Pure", "Helvetica Neue", "Roboto", sans-serif', fontSize: 13, h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });

// === 53. TOKYO NIGHT ===
const tokyonightLight = createTheme({ palette: { mode: 'light', primary: { main: '#2E7DE9' }, secondary: { main: '#9854F1' }, error: { main: '#F52A65' }, warning: { main: '#FF9E64' }, success: { main: '#587539' }, background: { default: '#D5D6DB', paper: '#E1E2E7' }, text: { primary: '#3760BF', secondary: '#6172B0' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #B4B5B9' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8 }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const tokyonightDark = createTheme({ palette: { mode: 'dark', primary: { main: '#7AA2F7' }, secondary: { main: '#BB9AF7' }, error: { main: '#F7768E' }, warning: { main: '#FF9E64' }, success: { main: '#9ECE6A' }, info: { main: '#7DCFFF' }, background: { default: '#1A1B26', paper: '#24283B' }, text: { primary: '#C0CAF5', secondary: '#565F89' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #565F89', backgroundColor: '#24283B' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8, border: '1px solid #565F89', backgroundColor: '#24283B' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#565F89' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 54. EVERFOREST ===
const everforestLight = createTheme({ palette: { mode: 'light', primary: { main: '#8DA101' }, secondary: { main: '#35A77C' }, error: { main: '#F85552' }, warning: { main: '#DFA000' }, success: { main: '#8DA101' }, background: { default: '#FDF6E3', paper: '#F3EAD3' }, text: { primary: '#5C6A72', secondary: '#829181' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #E0D5C1' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8 }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const everforestDark = createTheme({ palette: { mode: 'dark', primary: { main: '#A7C080' }, secondary: { main: '#83C092' }, error: { main: '#E67E80' }, warning: { main: '#DBBC7F' }, success: { main: '#A7C080' }, info: { main: '#7FBBB3' }, background: { default: '#2D353B', paper: '#343F44' }, text: { primary: '#D3C6AA', secondary: '#859289' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #4F585E', backgroundColor: '#343F44' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8, border: '1px solid #4F585E', backgroundColor: '#343F44' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#4F585E' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 55. ROSE PINE ===
const rosepineLight = createTheme({ palette: { mode: 'light', primary: { main: '#D7827E' }, secondary: { main: '#907AA9' }, error: { main: '#B4637A' }, warning: { main: '#EA9D34' }, success: { main: '#56949F' }, background: { default: '#FAF4ED', paper: '#FFFAF3' }, text: { primary: '#575279', secondary: '#797593' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #DFDAD9' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8 }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const rosepineDark = createTheme({ palette: { mode: 'dark', primary: { main: '#EB6F92' }, secondary: { main: '#C4A7E7' }, error: { main: '#EB6F92' }, warning: { main: '#F6C177' }, success: { main: '#9CCFD8' }, info: { main: '#31748F' }, background: { default: '#191724', paper: '#1F1D2E' }, text: { primary: '#E0DEF4', secondary: '#908CAA' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #403D52', backgroundColor: '#1F1D2E' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8, border: '1px solid #403D52', backgroundColor: '#1F1D2E' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#403D52' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 56. KANAGAWA ===
const kanagawaLight = createTheme({ palette: { mode: 'light', primary: { main: '#2D4F67' }, secondary: { main: '#957FB8' }, error: { main: '#C34043' }, warning: { main: '#DCA561' }, success: { main: '#76946A' }, background: { default: '#DCD7BA', paper: '#E8E3C8' }, text: { primary: '#1F1F28', secondary: '#54546D' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 6, border: '1px solid #C8C3A9' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 6 }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const kanagawaDark = createTheme({ palette: { mode: 'dark', primary: { main: '#7E9CD8' }, secondary: { main: '#957FB8' }, error: { main: '#C34043' }, warning: { main: '#DCA561' }, success: { main: '#76946A' }, info: { main: '#7FB4CA' }, background: { default: '#1F1F28', paper: '#2A2A37' }, text: { primary: '#DCD7BA', secondary: '#727169' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 6, border: '1px solid #54546D', backgroundColor: '#2A2A37' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 6, border: '1px solid #54546D', backgroundColor: '#2A2A37' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#54546D' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 57. AYU ===
const ayuLight = createTheme({ palette: { mode: 'light', primary: { main: '#FF8F40' }, secondary: { main: '#59C2FF' }, error: { main: '#F07171' }, warning: { main: '#E6B450' }, success: { main: '#AAD94C' }, background: { default: '#FAFAFA', paper: '#FFFFFF' }, text: { primary: '#5C6166', secondary: '#8A9199' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 6, border: '1px solid #E1E1E1' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 6 }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const ayuDark = createTheme({ palette: { mode: 'dark', primary: { main: '#E6B450' }, secondary: { main: '#59C2FF' }, error: { main: '#D95757' }, warning: { main: '#E6B450' }, success: { main: '#AAD94C' }, info: { main: '#59C2FF' }, background: { default: '#0B0E14', paper: '#11151C' }, text: { primary: '#BFBDB6', secondary: '#565B66' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 6, border: '1px solid #565B66', backgroundColor: '#11151C' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 6, border: '1px solid #565B66', backgroundColor: '#11151C' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#565B66' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 58. RETROWAVE ===
const retrowaveLight = createTheme({ palette: { mode: 'dark', primary: { main: '#00FFFF' }, secondary: { main: '#FF00FF' }, error: { main: '#FF0044' }, warning: { main: '#FFFF00' }, success: { main: '#00FF88' }, background: { default: '#1A0A2E', paper: '#2A1A3E' }, text: { primary: '#00FFFF', secondary: '#9966CC' } }, typography: { fontFamily: '"Orbitron", "Rajdhani", "Roboto", sans-serif', h1: { fontWeight: 700, letterSpacing: '0.08em' }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600, letterSpacing: '0.05em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 4 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 4, border: '1px solid #FF00FF40', boxShadow: '0 0 8px rgba(0,255,255,0.1)', backgroundColor: '#2A1A3E' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 4, border: '1px solid #00FFFF30', backgroundColor: '#2A1A3E' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4, border: '1px solid #00FFFF50', '&:hover': { boxShadow: '0 0 12px rgba(0,255,255,0.3)' } } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '6px 10px', borderColor: '#FF00FF20' } } }, MuiTooltip: { defaultProps: { arrow: false } } } });
const retrowaveDark = createTheme({ palette: { mode: 'dark', primary: { main: '#00FFFF' }, secondary: { main: '#FF00FF' }, error: { main: '#FF0044' }, warning: { main: '#FFFF00' }, success: { main: '#00FF88' }, background: { default: '#0D0520', paper: '#1A0A2E' }, text: { primary: '#00FFFF', secondary: '#7744AA' } }, typography: { fontFamily: '"Orbitron", "Rajdhani", "Roboto", sans-serif', h1: { fontWeight: 700, letterSpacing: '0.08em' }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600, letterSpacing: '0.05em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 4 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 4, border: '1px solid #FF00FF30', boxShadow: '0 0 6px rgba(0,255,255,0.08)', backgroundColor: '#1A0A2E' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 4, border: '1px solid #00FFFF25', backgroundColor: '#1A0A2E' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 4, border: '1px solid #00FFFF40', '&:hover': { boxShadow: '0 0 12px rgba(0,255,255,0.25)' } } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 4 } } }, MuiTableCell: { styleOverrides: { root: { padding: '6px 10px', borderColor: '#FF00FF15' } } }, MuiTooltip: { defaultProps: { arrow: false } } } });

// === 59. COTTAGECORE ===
const cottagecoreLight = createTheme({ palette: { mode: 'light', primary: { main: '#6B8E4E' }, secondary: { main: '#8B6B4E' }, error: { main: '#B85C5C' }, warning: { main: '#C4A35A' }, success: { main: '#6B8E4E' }, background: { default: '#F5EFE0', paper: '#FDFAF3' }, text: { primary: '#4A3C2A', secondary: '#7A6B5A' } }, typography: { fontFamily: '"Merriweather", "Georgia", serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 400, fontStyle: 'italic' as const }, h5: { fontWeight: 400 }, h6: { fontWeight: 700, fontSize: '0.85rem' }, body1: { lineHeight: 1.7 }, body2: { lineHeight: 1.6 }, button: { fontWeight: 500, fontFamily: '"Inter", "Roboto", sans-serif' } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #D5CBB8', boxShadow: 'none' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8, border: '1px solid #D5CBB8' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#D5CBB8' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const cottagecoreDark = createTheme({ palette: { mode: 'dark', primary: { main: '#8BAE6E' }, secondary: { main: '#AB8B6E' }, error: { main: '#D87C7C' }, warning: { main: '#D4B37A' }, success: { main: '#8BAE6E' }, background: { default: '#2A2418', paper: '#342E22' }, text: { primary: '#E5DFD0', secondary: '#A09880' } }, typography: { fontFamily: '"Merriweather", "Georgia", serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 400, fontStyle: 'italic' as const }, h5: { fontWeight: 400 }, h6: { fontWeight: 700, fontSize: '0.85rem' }, body1: { lineHeight: 1.7 }, body2: { lineHeight: 1.6 }, button: { fontWeight: 500, fontFamily: '"Inter", "Roboto", sans-serif' } }, shape: { borderRadius: 8 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 8, border: '1px solid #4A4234', boxShadow: 'none', backgroundColor: '#342E22' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 8, border: '1px solid #4A4234', backgroundColor: '#342E22' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'none' as const, borderRadius: 6 } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 6 } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#4A4234' } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 60. BRUTALIST ===
const brutalistLight = createTheme({ palette: { mode: 'light', primary: { main: '#000000' }, secondary: { main: '#555555' }, error: { main: '#FF0000' }, warning: { main: '#FF8800' }, success: { main: '#008800' }, background: { default: '#FFFFFF', paper: '#FFFFFF' }, text: { primary: '#000000', secondary: '#333333' }, divider: '#000000' }, typography: { fontFamily: '"Roboto Mono", "Courier New", monospace', h1: { fontWeight: 900, textTransform: 'uppercase' as const }, h2: { fontWeight: 900 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700, fontSize: '0.85rem', textTransform: 'uppercase' as const }, button: { fontWeight: 700, textTransform: 'uppercase' as const } }, shape: { borderRadius: 0 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 0, border: '3px solid #000', boxShadow: '4px 4px 0 #000' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 0, border: '3px solid #000', boxShadow: '4px 4px 0 #000' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'uppercase' as const, borderRadius: 0, border: '2px solid #000', fontWeight: 700, boxShadow: '3px 3px 0 #000', '&:hover': { boxShadow: '1px 1px 0 #000', transform: 'translate(2px, 2px)' } } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 0, border: '2px solid #000' } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#000', borderWidth: 2 } } }, MuiTooltip: { defaultProps: { arrow: true } } } });
const brutalistDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FFFFFF' }, secondary: { main: '#AAAAAA' }, error: { main: '#FF4444' }, warning: { main: '#FFAA44' }, success: { main: '#44AA44' }, background: { default: '#000000', paper: '#0A0A0A' }, text: { primary: '#FFFFFF', secondary: '#CCCCCC' }, divider: '#FFFFFF' }, typography: { fontFamily: '"Roboto Mono", "Courier New", monospace', h1: { fontWeight: 900, textTransform: 'uppercase' as const }, h2: { fontWeight: 900 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700, fontSize: '0.85rem', textTransform: 'uppercase' as const }, button: { fontWeight: 700, textTransform: 'uppercase' as const } }, shape: { borderRadius: 0 }, components: { ...baseComponents, MuiPaper: { styleOverrides: { root: { borderRadius: 0, border: '3px solid #FFF', boxShadow: '4px 4px 0 #FFF', backgroundColor: '#0A0A0A' } } }, MuiCard: { styleOverrides: { root: ({ theme }) => ({ padding: theme.spacing(2), borderRadius: 0, border: '3px solid #FFF', boxShadow: '4px 4px 0 #FFF', backgroundColor: '#0A0A0A' }) } }, MuiButton: { styleOverrides: { root: { textTransform: 'uppercase' as const, borderRadius: 0, border: '2px solid #FFF', fontWeight: 700, color: '#FFF', boxShadow: '3px 3px 0 #FFF', '&:hover': { boxShadow: '1px 1px 0 #FFF', transform: 'translate(2px, 2px)' } } } }, MuiChip: { defaultProps: { size: 'small' }, styleOverrides: { root: { borderRadius: 0, border: '2px solid #FFF' } } }, MuiTableCell: { styleOverrides: { root: { padding: '8px 12px', borderColor: '#FFF', borderWidth: 2 } } }, MuiTooltip: { defaultProps: { arrow: true } } } });

// === 61. RISC OS ===
const riscosLight = createTheme({ palette: { mode: 'light', primary: { main: '#6666AA' }, secondary: { main: '#888888' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#E0E0D0', paper: '#F0F0E8' }, text: { primary: '#000000', secondary: '#444444' } }, typography: { fontFamily: '"Helvetica", "Arial", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });
const riscosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#8888CC' }, secondary: { main: '#AAAAAA' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#2A2A28', paper: '#3A3A38' }, text: { primary: '#E0E0D0', secondary: '#999988' } }, typography: { fontFamily: '"Helvetica", "Arial", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 62. PALM WEBOS ===
const webosLight = createTheme({ palette: { mode: 'dark', primary: { main: '#FF8C00' }, secondary: { main: '#888888' }, error: { main: '#EE4444' }, warning: { main: '#FF8C00' }, success: { main: '#44AA44' }, background: { default: '#292929', paper: '#3A3A3A' }, text: { primary: '#FFFFFF', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Prelude", "Helvetica Neue", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 12 }, components: baseComponents });
const webosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FF8C00' }, secondary: { main: '#666666' }, error: { main: '#EE4444' }, warning: { main: '#FF8C00' }, success: { main: '#44AA44' }, background: { default: '#1A1A1A', paper: '#2A2A2A' }, text: { primary: '#FFFFFF', secondary: '#888888' } }, typography: { fontFamily: '"Prelude", "Helvetica Neue", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 12 }, components: baseComponents });

// === 63. WINDOWS PHONE ===
const windowsphoneLight = createTheme({ palette: { mode: 'dark', primary: { main: '#0078D7' }, secondary: { main: '#888888' }, error: { main: '#E81123' }, warning: { main: '#FF8C00' }, success: { main: '#107C10' }, background: { default: '#000000', paper: '#1A1A1A' }, text: { primary: '#FFFFFF', secondary: '#999999' } }, typography: { fontFamily: '"Segoe UI", "Segoe WP", "Roboto", sans-serif', h1: { fontWeight: 200, fontSize: '2.5rem' }, h2: { fontWeight: 200 }, h3: { fontWeight: 300 }, h4: { fontWeight: 400 }, h5: { fontWeight: 400 }, h6: { fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.1em', fontSize: '0.85rem' }, button: { fontWeight: 600 } }, shape: { borderRadius: 0 }, components: baseComponents });
const windowsphoneDark = createTheme({ palette: { mode: 'dark', primary: { main: '#0078D7' }, secondary: { main: '#666666' }, error: { main: '#E81123' }, warning: { main: '#FF8C00' }, success: { main: '#107C10' }, background: { default: '#000000', paper: '#111111' }, text: { primary: '#FFFFFF', secondary: '#888888' } }, typography: { fontFamily: '"Segoe UI", "Segoe WP", "Roboto", sans-serif', h1: { fontWeight: 200, fontSize: '2.5rem' }, h2: { fontWeight: 200 }, h3: { fontWeight: 300 }, h4: { fontWeight: 400 }, h5: { fontWeight: 400 }, h6: { fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.1em', fontSize: '0.85rem' }, button: { fontWeight: 600 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 64. BLACKBERRY 10 ===
const blackberryLight = createTheme({ palette: { mode: 'dark', primary: { main: '#CC0000' }, secondary: { main: '#555555' }, error: { main: '#FF3333' }, warning: { main: '#FF8800' }, success: { main: '#44AA44' }, background: { default: '#1A1A1A', paper: '#333333' }, text: { primary: '#FFFFFF', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Slate Pro", "Helvetica Neue", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });
const blackberryDark = createTheme({ palette: { mode: 'dark', primary: { main: '#CC0000' }, secondary: { main: '#444444' }, error: { main: '#FF3333' }, warning: { main: '#FF8800' }, success: { main: '#44AA44' }, background: { default: '#0D0D0D', paper: '#1A1A1A' }, text: { primary: '#EEEEEE', secondary: '#888888' } }, typography: { fontFamily: '"Slate Pro", "Helvetica Neue", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });

// === 65. SAMSUNG TIZEN ===
const tizenLight = createTheme({ palette: { mode: 'light', primary: { main: '#0093E0' }, secondary: { main: '#00BCD4' }, error: { main: '#E53935' }, warning: { main: '#FF9800' }, success: { main: '#4CAF50' }, background: { default: '#F0F4F8', paper: '#FFFFFF' }, text: { primary: '#1C2127', secondary: '#5A6370' } }, typography: { fontFamily: '"SamsungOne", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 12 }, components: baseComponents });
const tizenDark = createTheme({ palette: { mode: 'dark', primary: { main: '#0093E0' }, secondary: { main: '#00BCD4' }, error: { main: '#EF5350' }, warning: { main: '#FFA726' }, success: { main: '#66BB6A' }, background: { default: '#1C2127', paper: '#272D35' }, text: { primary: '#E8ECF0', secondary: '#8A95A5' } }, typography: { fontFamily: '"SamsungOne", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 12 }, components: baseComponents });

// === 66. SAILFISH OS ===
const sailfishLight = createTheme({ palette: { mode: 'dark', primary: { main: '#FFB74D' }, secondary: { main: '#26C6DA' }, error: { main: '#EF5350' }, warning: { main: '#FFB74D' }, success: { main: '#66BB6A' }, background: { default: '#1A1A2E', paper: '#252540' }, text: { primary: '#FFFFFF', secondary: '#AAAACC' } }, typography: { fontFamily: '"Sail Sans Pro", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });
const sailfishDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FFB74D' }, secondary: { main: '#26C6DA' }, error: { main: '#EF5350' }, warning: { main: '#FFB74D' }, success: { main: '#66BB6A' }, background: { default: '#0D0D1A', paper: '#1A1A2E' }, text: { primary: '#E8E8F0', secondary: '#8888AA' } }, typography: { fontFamily: '"Sail Sans Pro", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });

// === 67. OPENSTEP ===
const openstepLight = createTheme({ palette: { mode: 'light', primary: { main: '#555555' }, secondary: { main: '#888888' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#AAAAAA', paper: '#E0E0E0' }, text: { primary: '#000000', secondary: '#333333' } }, typography: { fontFamily: '"Helvetica Neue", Helvetica, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });
const openstepDark = createTheme({ palette: { mode: 'dark', primary: { main: '#888888' }, secondary: { main: '#AAAAAA' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#333333', paper: '#444444' }, text: { primary: '#E0E0E0', secondary: '#AAAAAA' } }, typography: { fontFamily: '"Helvetica Neue", Helvetica, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });

// === 68. MORPHOS ===
const morphosLight = createTheme({ palette: { mode: 'dark', primary: { main: '#4CAF50' }, secondary: { main: '#2196F3' }, error: { main: '#EF5350' }, warning: { main: '#FF9800' }, success: { main: '#4CAF50' }, background: { default: '#1E2D3D', paper: '#283848' }, text: { primary: '#E0E8F0', secondary: '#8899AA' } }, typography: { fontFamily: '"Roboto", "Helvetica Neue", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });
const morphosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#4CAF50' }, secondary: { main: '#2196F3' }, error: { main: '#EF5350' }, warning: { main: '#FF9800' }, success: { main: '#4CAF50' }, background: { default: '#0F1A24', paper: '#1E2D3D' }, text: { primary: '#D0D8E0', secondary: '#667788' } }, typography: { fontFamily: '"Roboto", "Helvetica Neue", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 4 }, components: baseComponents });

// === 69. REACTOS ===
const reactosLight = createTheme({ palette: { mode: 'light', primary: { main: '#3A6EA5' }, secondary: { main: '#808080' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#C0C0C0', paper: '#E0E0E0' }, text: { primary: '#000000', secondary: '#444444' } }, typography: { fontFamily: 'Tahoma, "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });
const reactosDark = createTheme({ palette: { mode: 'dark', primary: { main: '#5A8EC5' }, secondary: { main: '#999999' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#2A2A2A', paper: '#3A3A3A' }, text: { primary: '#E0E0E0', secondary: '#999999' } }, typography: { fontFamily: 'Tahoma, "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 70. HP-UX / CDE ===
const hpuxLight = createTheme({ palette: { mode: 'light', primary: { main: '#6B2D8B' }, secondary: { main: '#A0A0A0' }, error: { main: '#CC3333' }, warning: { main: '#CC9933' }, success: { main: '#339933' }, background: { default: '#C4B07A', paper: '#D8CCA0' }, text: { primary: '#1A1A1A', secondary: '#444444' } }, typography: { fontFamily: '"Helvetica", "Roboto", Arial, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });
const hpuxDark = createTheme({ palette: { mode: 'dark', primary: { main: '#9B5DBB' }, secondary: { main: '#888888' }, error: { main: '#EE5555' }, warning: { main: '#EEBB55' }, success: { main: '#55BB55' }, background: { default: '#2A2418', paper: '#3A3428' }, text: { primary: '#D8CCA0', secondary: '#999977' } }, typography: { fontFamily: '"Helvetica", "Roboto", Arial, sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 2 }, components: baseComponents });

// === 71. MATERIAL THEME ===
const materialLight = createTheme({ palette: { mode: 'light', primary: { main: '#009688' }, secondary: { main: '#607D8B' }, error: { main: '#FF5370' }, warning: { main: '#FFCB6B' }, success: { main: '#C3E88D' }, background: { default: '#FAFAFA', paper: '#FFFFFF' }, text: { primary: '#263238', secondary: '#546E7A' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });
const materialDark = createTheme({ palette: { mode: 'dark', primary: { main: '#009688' }, secondary: { main: '#607D8B' }, error: { main: '#FF5370' }, warning: { main: '#FFCB6B' }, success: { main: '#C3E88D' }, info: { main: '#82AAFF' }, background: { default: '#263238', paper: '#2E3C43' }, text: { primary: '#EEFFFF', secondary: '#607D8B' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });

// === 72. NIGHT OWL ===
const nightowlLight = createTheme({ palette: { mode: 'light', primary: { main: '#2AA298' }, secondary: { main: '#7C4DFF' }, error: { main: '#EF5350' }, warning: { main: '#FFAB40' }, success: { main: '#22DA6E' }, background: { default: '#F6F6F6', paper: '#FFFFFF' }, text: { primary: '#403F53', secondary: '#7A7A8C' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });
const nightowlDark = createTheme({ palette: { mode: 'dark', primary: { main: '#22DA6E' }, secondary: { main: '#C792EA' }, error: { main: '#EF5350' }, warning: { main: '#FFAB40' }, success: { main: '#22DA6E' }, info: { main: '#82AAFF' }, background: { default: '#011627', paper: '#0B2942' }, text: { primary: '#D6DEEB', secondary: '#637777' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });

// === 73. VITESSE ===
const vitesseLight = createTheme({ palette: { mode: 'light', primary: { main: '#B07D48' }, secondary: { main: '#59873A' }, error: { main: '#AB5959' }, warning: { main: '#DBB168' }, success: { main: '#59873A' }, background: { default: '#F8F8F8', paper: '#FFFFFF' }, text: { primary: '#393A34', secondary: '#7A7A7A' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });
const vitesseDark = createTheme({ palette: { mode: 'dark', primary: { main: '#DBB168' }, secondary: { main: '#80A665' }, error: { main: '#CB7676' }, warning: { main: '#DBB168' }, success: { main: '#80A665' }, info: { main: '#6394BF' }, background: { default: '#121212', paper: '#1E1E1E' }, text: { primary: '#DDD6C1', secondary: '#7A7A7A' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });

// === 74. PALENIGHT ===
const palenightLight = createTheme({ palette: { mode: 'light', primary: { main: '#6C63FF' }, secondary: { main: '#FF5370' }, error: { main: '#FF5370' }, warning: { main: '#FFCB6B' }, success: { main: '#C3E88D' }, background: { default: '#E8E8F0', paper: '#F0F0FA' }, text: { primary: '#292D3E', secondary: '#676E95' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });
const palenightDark = createTheme({ palette: { mode: 'dark', primary: { main: '#C792EA' }, secondary: { main: '#FF5370' }, error: { main: '#FF5370' }, warning: { main: '#FFCB6B' }, success: { main: '#C3E88D' }, info: { main: '#82AAFF' }, background: { default: '#292D3E', paper: '#34324A' }, text: { primary: '#A6ACCD', secondary: '#676E95' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 8 }, components: baseComponents });

// === 75. COBALT2 ===
const cobaltLight = createTheme({ palette: { mode: 'light', primary: { main: '#0088FF' }, secondary: { main: '#FF9D00' }, error: { main: '#FF3333' }, warning: { main: '#FFC600' }, success: { main: '#3AD900' }, background: { default: '#E8F0F8', paper: '#FFFFFF' }, text: { primary: '#193549', secondary: '#446688' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });
const cobaltDark = createTheme({ palette: { mode: 'dark', primary: { main: '#0088FF' }, secondary: { main: '#FF9D00' }, error: { main: '#FF3333' }, warning: { main: '#FFC600' }, success: { main: '#3AD900' }, info: { main: '#80FCFF' }, background: { default: '#193549', paper: '#1F4662' }, text: { primary: '#FFFFFF', secondary: '#6699BB' } }, typography: { fontFamily: '"Fira Code", "Roboto Mono", monospace', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 6 }, components: baseComponents });

// === 76. SOLARPUNK ===
const solarpunkLight = createTheme({ palette: { mode: 'light', primary: { main: '#4A7C59' }, secondary: { main: '#C89B3C' }, error: { main: '#CC5544' }, warning: { main: '#C89B3C' }, success: { main: '#4A7C59' }, background: { default: '#F5F0E1', paper: '#FDFAF0' }, text: { primary: '#2A3D2E', secondary: '#6B7D6F' } }, typography: { fontFamily: '"Inter", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 10 }, components: baseComponents });
const solarpunkDark = createTheme({ palette: { mode: 'dark', primary: { main: '#6A9C79' }, secondary: { main: '#D8AB4C' }, error: { main: '#EE7766' }, warning: { main: '#D8AB4C' }, success: { main: '#6A9C79' }, background: { default: '#1A2A1E', paper: '#243028' }, text: { primary: '#E5E0D1', secondary: '#8A9D8E' } }, typography: { fontFamily: '"Inter", "Roboto", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 10 }, components: baseComponents });

// === 77. Y2K AESTHETIC ===
const y2kLight = createTheme({ palette: { mode: 'light', primary: { main: '#9B59B6' }, secondary: { main: '#6C5CE7' }, error: { main: '#E74C3C' }, warning: { main: '#F39C12' }, success: { main: '#2ECC71' }, background: { default: '#E8E0F0', paper: '#F5F0FA' }, text: { primary: '#333355', secondary: '#8888AA' } }, typography: { fontFamily: '"Trebuchet MS", "Tahoma", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 600 } }, shape: { borderRadius: 16 }, components: baseComponents });
const y2kDark = createTheme({ palette: { mode: 'dark', primary: { main: '#BB79D6' }, secondary: { main: '#8C7CF7' }, error: { main: '#FF6C5C' }, warning: { main: '#FFBC32' }, success: { main: '#4EEC91' }, background: { default: '#1A1428', paper: '#2A2438' }, text: { primary: '#E8E0F0', secondary: '#8888AA' } }, typography: { fontFamily: '"Trebuchet MS", "Tahoma", sans-serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 600 }, button: { fontWeight: 600 } }, shape: { borderRadius: 16 }, components: baseComponents });

// === 78. FILM NOIR ===
const noirLight = createTheme({ palette: { mode: 'light', primary: { main: '#333333' }, secondary: { main: '#888888' }, error: { main: '#AA0000' }, warning: { main: '#888888' }, success: { main: '#555555' }, background: { default: '#F5F5F5', paper: '#FFFFFF' }, text: { primary: '#0A0A0A', secondary: '#666666' }, divider: '#CCCCCC' }, typography: { fontFamily: '"Playfair Display", "Georgia", serif', h1: { fontWeight: 900 }, h2: { fontWeight: 900 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '0.1em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 0 }, components: baseComponents });
const noirDark = createTheme({ palette: { mode: 'dark', primary: { main: '#F5F5F5' }, secondary: { main: '#888888' }, error: { main: '#CC3333' }, warning: { main: '#888888' }, success: { main: '#AAAAAA' }, background: { default: '#0A0A0A', paper: '#141414' }, text: { primary: '#F5F5F5', secondary: '#888888' }, divider: '#333333' }, typography: { fontFamily: '"Playfair Display", "Georgia", serif', h1: { fontWeight: 900 }, h2: { fontWeight: 900 }, h3: { fontWeight: 700 }, h4: { fontWeight: 700 }, h5: { fontWeight: 700 }, h6: { fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '0.1em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 0 }, components: baseComponents });

// === 79. PASTEL DREAM ===
const pastelLight = createTheme({ palette: { mode: 'light', primary: { main: '#FFB6C1' }, secondary: { main: '#E6E6FA' }, error: { main: '#FF8888' }, warning: { main: '#FFD700' }, success: { main: '#98FFB8' }, background: { default: '#FFF0F5', paper: '#FFFFFF' }, text: { primary: '#5A4A5A', secondary: '#8A7A8A' } }, typography: { fontFamily: '"Quicksand", "Nunito", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 16 }, components: baseComponents });
const pastelDark = createTheme({ palette: { mode: 'dark', primary: { main: '#FFB6C1' }, secondary: { main: '#C8C8E8' }, error: { main: '#FF8888' }, warning: { main: '#FFD700' }, success: { main: '#88DD98' }, background: { default: '#2A2030', paper: '#352A3A' }, text: { primary: '#F0E8F0', secondary: '#A898A8' } }, typography: { fontFamily: '"Quicksand", "Nunito", "Roboto", sans-serif', h1: { fontWeight: 600 }, h2: { fontWeight: 600 }, h3: { fontWeight: 500 }, h4: { fontWeight: 500 }, h5: { fontWeight: 500 }, h6: { fontWeight: 600 }, button: { fontWeight: 500 } }, shape: { borderRadius: 16 }, components: baseComponents });

// === 80. STEAMPUNK ===
const steampunkLight = createTheme({ palette: { mode: 'dark', primary: { main: '#B8860B' }, secondary: { main: '#B87333' }, error: { main: '#CC4444' }, warning: { main: '#B8860B' }, success: { main: '#668844' }, background: { default: '#1A1209', paper: '#2A2015' }, text: { primary: '#D4C4A0', secondary: '#8A7A60' } }, typography: { fontFamily: '"Spectral", "Georgia", serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 700, letterSpacing: '0.05em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 4 }, components: baseComponents });
const steampunkDark = createTheme({ palette: { mode: 'dark', primary: { main: '#B8860B' }, secondary: { main: '#B87333' }, error: { main: '#CC4444' }, warning: { main: '#B8860B' }, success: { main: '#668844' }, background: { default: '#0D0905', paper: '#1A1209' }, text: { primary: '#C4B490', secondary: '#7A6A50' } }, typography: { fontFamily: '"Spectral", "Georgia", serif', h1: { fontWeight: 700 }, h2: { fontWeight: 700 }, h3: { fontWeight: 600 }, h4: { fontWeight: 600 }, h5: { fontWeight: 600 }, h6: { fontWeight: 700, letterSpacing: '0.05em' }, button: { fontWeight: 600 } }, shape: { borderRadius: 4 }, components: baseComponents });
...
const tabPresets: Partial<Record<ThemeName, ThemeOptions['components']>> = {
  ...
  tos: macTabs, templeos: dosTabs, haiku: beosTabs, plan9: macTabs, solaris: win9xTabs,
  win10: fluentTabs, kde: macTabs, mint: macTabs, redhat: macTabs, zxspectrum: c64Tabs,
  atari: win9xTabs, symbian: palmTabs, retrowave: synthwaveTabs,
  riscos: win9xTabs, webos: macTabs, windowsphone: fluentTabs, blackberry: macTabs,
  tizen: macTabs, sailfish: macTabs, openstep: nextstepTabs, morphos: amigaTabs,
  reactos: win9xTabs, hpux: win9xTabs,
};
...
export const THEMES: Record<ThemeName, AppThemeDef> = {
  ...
  ayu: { name: 'ayu', label: 'Editor - Ayu', description: 'Warm amber/orange accents on dark', light: ayuLight, dark: ayuDark, custom: { headerBg: (m) => m === 'dark' ? '#0B0E14' : '#FAFAFA', headerColor: '', brandBlockBg: '#E6B450', brandBlockColor: '#0B0E14', sidebarBg: () => 'transparent', cardBorderRadius: 6 } },
  ...
  everforest: { name: 'everforest', label: 'Editor - Everforest', description: 'Warm green forest tones', light: everforestLight, dark: everforestDark, custom: { headerBg: (m) => m === 'dark' ? '#2D353B' : '#FDF6E3', headerColor: '', brandBlockBg: '#A7C080', brandBlockColor: '#2D353B', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  ...
  kanagawa: { name: 'kanagawa', label: 'Editor - Kanagawa', description: 'Japanese wave art colors on dark blue', light: kanagawaLight, dark: kanagawaDark, custom: { headerBg: (m) => m === 'dark' ? '#1F1F28' : '#DCD7BA', headerColor: '', brandBlockBg: '#7E9CD8', brandBlockColor: '#1F1F28', sidebarBg: () => 'transparent', cardBorderRadius: 6 } },
  ...
  rosepine: { name: 'rosepine', label: 'Editor - Rosé Pine', description: 'Muted rose, purple and gold accents', light: rosepineLight, dark: rosepineDark, custom: { headerBg: (m) => m === 'dark' ? '#191724' : '#FAF4ED', headerColor: '', brandBlockBg: '#EB6F92', brandBlockColor: '#191724', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  ...
  tokyonight: { name: 'tokyonight', label: 'Editor - Tokyo Night', description: 'Deep blue-purple with soft contrast', light: tokyonightLight, dark: tokyonightDark, custom: { headerBg: (m) => m === 'dark' ? '#1A1B26' : '#D5D6DB', headerColor: '', brandBlockBg: '#7AA2F7', brandBlockColor: '#1A1B26', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  ...
  cobalt: { name: 'cobalt', label: 'Editor - Cobalt2', description: 'Rich blue with yellow/orange highlights', light: cobaltLight, dark: cobaltDark, custom: { headerBg: (m) => m === 'dark' ? '#193549' : '#E8F0F8', headerColor: '', brandBlockBg: '#FFC600', brandBlockColor: '#193549', sidebarBg: () => 'transparent', cardBorderRadius: 6 } },
  material: { name: 'material', label: 'Editor - Material', description: 'Deep blue-grey with teal accents', light: materialLight, dark: materialDark, custom: { headerBg: (m) => m === 'dark' ? '#263238' : '#FAFAFA', headerColor: '', brandBlockBg: '#009688', brandBlockColor: '#EEFFFF', sidebarBg: () => 'transparent', cardBorderRadius: 6 } },
  nightowl: { name: 'nightowl', label: 'Editor - Night Owl', description: 'Deep navy with vibrant green/magenta', light: nightowlLight, dark: nightowlDark, custom: { headerBg: (m) => m === 'dark' ? '#011627' : '#F6F6F6', headerColor: '', brandBlockBg: '#22DA6E', brandBlockColor: '#011627', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  palenight: { name: 'palenight', label: 'Editor - Palenight', description: 'Purple-blue with pink accents', light: palenightLight, dark: palenightDark, custom: { headerBg: (m) => m === 'dark' ? '#292D3E' : '#E8E8F0', headerColor: '', brandBlockBg: '#C792EA', brandBlockColor: '#292D3E', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  vitesse: { name: 'vitesse', label: 'Editor - Vitesse', description: 'Warm amber/orange on soft dark', light: vitesseLight, dark: vitesseDark, custom: { headerBg: (m) => m === 'dark' ? '#121212' : '#F8F8F8', headerColor: '', brandBlockBg: '#DBB168', brandBlockColor: '#121212', sidebarBg: () => 'transparent', cardBorderRadius: 6 } },

  // ── OS themes (alphabetical) ──
  atari: { name: 'atari', label: 'OS - Atari ST GEM', description: 'Green/white monochrome GEM desktop', light: atariLight, dark: atariDark, custom: { headerBg: () => '#00AA00', headerColor: '#fff', brandBlockBg: '#00AA00', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  blackberry: { name: 'blackberry', label: 'OS - BlackBerry 10', description: 'Dark charcoal with red accents', light: blackberryLight, dark: blackberryDark, custom: { headerBg: (m) => m === 'dark' ? '#0D0D0D' : '#1A1A1A', headerColor: '#fff', brandBlockBg: '#CC0000', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 6 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  hpux: { name: 'hpux', label: 'OS - HP-UX CDE', description: 'Tan/brown Motif style with HP purple accents', light: hpuxLight, dark: hpuxDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2418' : '#6B2D8B', headerColor: '#fff', brandBlockBg: '#6B2D8B', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 2 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  haiku: { name: 'haiku', label: 'OS - Haiku', description: 'BeOS successor with yellow tabs and clean grey', light: haikuLight, dark: haikuDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2A2A' : '#FFD700', headerColor: '#000', brandBlockBg: '#3B7AB8', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 4 }, windowChrome: { buttonPosition: 'left', buttonStyle: 'beos' } },
  ...
  kde: { name: 'kde', label: 'OS - KDE Plasma', description: 'Breeze theme with blue/purple accents', light: kdeLight, dark: kdeDark, custom: { headerBg: (m) => m === 'dark' ? '#232629' : '#EFF0F1', headerColor: '', brandBlockBg: '#3DAEE9', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 4 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  mint: { name: 'mint', label: 'OS - Linux Mint', description: 'Green Cinnamon desktop with grey tones', light: mintLight, dark: mintDark, custom: { headerBg: (m) => m === 'dark' ? '#2B2B2B' : '#2B5329', headerColor: '#fff', brandBlockBg: '#87CF3E', brandBlockColor: '#2B5329', sidebarBg: () => 'transparent', cardBorderRadius: 4 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  plan9: { name: 'plan9', label: 'OS - Plan 9', description: 'Bell Labs Rio window manager, light green/cream', light: plan9Light, dark: plan9Dark, custom: { headerBg: (m) => m === 'dark' ? '#2A3A2A' : '#7777CC', headerColor: '#fff', brandBlockBg: '#7777CC', brandBlockColor: '#FFFFEA', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  reactos: { name: 'reactos', label: 'OS - ReactOS', description: 'Windows-compatible classic blue/silver style', light: reactosLight, dark: reactosDark, custom: { headerBg: () => '#000080', headerColor: '#fff', brandBlockBg: '#3A6EA5', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'win95' } },
  redhat: { name: 'redhat', label: 'OS - Red Hat', description: 'Dark blue with red Fedora accents', light: redhatLight, dark: redhatDark, custom: { headerBg: (m) => m === 'dark' ? '#21272D' : '#EE0000', headerColor: '#fff', brandBlockBg: '#EE0000', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 4 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'gnome' } },
  morphos: { name: 'morphos', label: 'OS - MorphOS', description: 'Amiga successor with modern dark blue/green UI', light: morphosLight, dark: morphosDark, custom: { headerBg: (m) => m === 'dark' ? '#0F1A24' : '#1E2D3D', headerColor: '#4CAF50', brandBlockBg: '#4CAF50', brandBlockColor: '#1E2D3D', sidebarBg: () => 'transparent', cardBorderRadius: 4 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'amiga' } },
  ...
  openstep: { name: 'openstep', label: 'OS - OpenStep', description: 'Dark grey NeXT evolution with vertical menu', light: openstepLight, dark: openstepDark, custom: { headerBg: (m) => m === 'dark' ? '#333333' : '#555555', headerColor: '#fff', brandBlockBg: '#333333', brandBlockColor: '#E0E0E0', sidebarBg: () => 'transparent', cardBorderRadius: 2 }, windowChrome: { buttonPosition: 'left', buttonStyle: 'nextstep' } },
  ...
  sailfish: { name: 'sailfish', label: 'OS - Sailfish OS', description: 'Jolla dark with amber/teal highlights', light: sailfishLight, dark: sailfishDark, custom: { headerBg: (m) => m === 'dark' ? '#0D0D1A' : '#1A1A2E', headerColor: '#FFB74D', brandBlockBg: '#FFB74D', brandBlockColor: '#1A1A2E', sidebarBg: () => 'transparent', cardBorderRadius: 8 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  solaris: { name: 'solaris', label: 'OS - Solaris CDE', description: 'Purple/blue Motif CDE window style', light: solarisLight, dark: solarisDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2A3E' : '#4B348B', headerColor: '#fff', brandBlockBg: '#4B348B', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 2 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  tizen: { name: 'tizen', label: 'OS - Samsung Tizen', description: 'Blue/cyan gradient with modern Samsung feel', light: tizenLight, dark: tizenDark, custom: { headerBg: (m) => m === 'dark' ? '#1C2127' : '#0093E0', headerColor: '#fff', brandBlockBg: '#0093E0', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 12 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  symbian: { name: 'symbian', label: 'OS - Symbian', description: 'Nokia S60 blue/silver small-screen UI', light: symbianLight, dark: symbianDark, custom: { headerBg: (m) => m === 'dark' ? '#1A1A2E' : '#005BAD', headerColor: '#fff', brandBlockBg: '#005BAD', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 6 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  riscos: { name: 'riscos', label: 'OS - RISC OS', description: 'Acorn Archimedes cream/grey with icon bar', light: riscosLight, dark: riscosDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2A28' : '#6666AA', headerColor: '#fff', brandBlockBg: '#6666AA', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  templeos: { name: 'templeos', label: 'OS - TempleOS', description: '640x480 VGA, white on blue CGA-inspired', light: templeosLight, dark: templeosDark, custom: { headerBg: () => '#0000AA', headerColor: '#fff', brandBlockBg: '#0000AA', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  tos: { name: 'tos', label: 'OS - Star Trek LCARS', description: 'Black with orange/blue/red LCARS panels', light: tosLight, dark: tosDark, custom: { headerBg: () => '#000000', headerColor: '#FF9900', brandBlockBg: '#FF9900', brandBlockColor: '#000', sidebarBg: () => 'transparent', cardBorderRadius: 16 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  win10: { name: 'win10', label: 'OS - Windows 10', description: 'Flat dark with blue accent color', light: win10Light, dark: win10Dark, custom: { headerBg: (m) => m === 'dark' ? '#001524' : '#F3F3F3', headerColor: '', brandBlockBg: '#0078D7', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 2 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'fluent' } },
  ...
  webos: { name: 'webos', label: 'OS - Palm webOS', description: 'Dark card-based UI with orange/grey accents', light: webosLight, dark: webosDark, custom: { headerBg: (m) => m === 'dark' ? '#1A1A1A' : '#292929', headerColor: '#FF8C00', brandBlockBg: '#FF8C00', brandBlockColor: '#292929', sidebarBg: () => 'transparent', cardBorderRadius: 12 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  zxspectrum: { name: 'zxspectrum', label: 'OS - ZX Spectrum', description: 'Rainbow stripes, bright colors on black', light: zxspectrumLight, dark: zxspectrumDark, custom: { headerBg: () => '#000000', headerColor: '#00FF00', brandBlockBg: '#FF0000', brandBlockColor: '#FFFF00', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  windowsphone: { name: 'windowsphone', label: 'OS - Windows Phone', description: 'Dark with colourful Metro tiles, Segoe font', light: windowsphoneLight, dark: windowsphoneDark, custom: { headerBg: (m) => m === 'dark' ? '#000000' : '#000000', headerColor: '#fff', brandBlockBg: '#0078D7', brandBlockColor: '#fff', sidebarBg: () => 'transparent', cardBorderRadius: 0 }, windowChrome: { buttonPosition: 'right', buttonStyle: 'default' } },
  ...
  // ── Vibes (alphabetical) ──
  noir: { name: 'noir', label: 'Vibe - Film Noir', description: 'Pure black/white/grey, dramatic contrast', light: noirLight, dark: noirDark, custom: { headerBg: (m) => m === 'dark' ? '#0A0A0A' : '#F5F5F5', headerColor: '', brandBlockBg: '#333333', brandBlockColor: '#F5F5F5', sidebarBg: () => 'transparent', cardBorderRadius: 0 } },
  pastel: { name: 'pastel', label: 'Vibe - Pastel Dream', description: 'Soft pink/lavender/mint, light and airy', light: pastelLight, dark: pastelDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2030' : '#FFF0F5', headerColor: '', brandBlockBg: '#FFB6C1', brandBlockColor: '#5A4A5A', sidebarBg: () => 'transparent', cardBorderRadius: 16 } },
  solarpunk: { name: 'solarpunk', label: 'Vibe - Solarpunk', description: 'Optimistic green/gold, nature-tech warmth', light: solarpunkLight, dark: solarpunkDark, custom: { headerBg: (m) => m === 'dark' ? '#1A2A1E' : '#F5F0E1', headerColor: '', brandBlockBg: '#4A7C59', brandBlockColor: '#F5F0E1', sidebarBg: () => 'transparent', cardBorderRadius: 10 } },
  steampunk: { name: 'steampunk', label: 'Vibe - Steampunk', description: 'Dark brown/brass/copper, industrial warm', light: steampunkLight, dark: steampunkDark, custom: { headerBg: (m) => m === 'dark' ? '#0D0905' : '#1A1209', headerColor: '#B8860B', brandBlockBg: '#B8860B', brandBlockColor: '#1A1209', sidebarBg: () => 'transparent', cardBorderRadius: 4 } },
  y2k: { name: 'y2k', label: 'Vibe - Y2K', description: 'Chrome silver, iridescent purple/blue, bubbly', light: y2kLight, dark: y2kDark, custom: { headerBg: (m) => m === 'dark' ? '#1A1428' : '#E8E0F0', headerColor: '', brandBlockBg: '#9B59B6', brandBlockColor: '#E8E0F0', sidebarBg: () => 'transparent', cardBorderRadius: 16 } },
  brutalist: { name: 'brutalist', label: 'Vibe - Brutalist', description: 'Raw monospace, high contrast, thick borders', light: brutalistLight, dark: brutalistDark, custom: { headerBg: (m) => m === 'dark' ? '#000' : '#FFF', headerColor: '#000', brandBlockBg: '#000', brandBlockColor: '#FFF', sidebarBg: () => 'transparent', cardBorderRadius: 0 } },
  cottagecore: { name: 'cottagecore', label: 'Vibe - Cottagecore', description: 'Warm cream/green/brown, cozy serif font', light: cottagecoreLight, dark: cottagecoreDark, custom: { headerBg: (m) => m === 'dark' ? '#2A2418' : '#F5EFE0', headerColor: '', brandBlockBg: '#6B8E4E', brandBlockColor: '#F5EFE0', sidebarBg: () => 'transparent', cardBorderRadius: 8 } },
  ...
  retrowave: { name: 'retrowave', label: 'Vibe - Retrowave', description: 'Chrome text feel, dark purple/teal neon', light: retrowaveLight, dark: retrowaveDark, custom: { headerBg: () => '#1A0A2E', headerColor: '#00FFFF', brandBlockBg: '#FF00FF', brandBlockColor: '#000', sidebarBg: () => 'transparent', cardBorderRadius: 4 } },
...
export const THEME_NAMES: ThemeName[] = [
  ...
  // Editor Themes
  'ayu', 'catppuccin', 'cobalt', 'dracula', 'everforest', 'gruvbox', 'kanagawa', 'material', 'monokai', 'nightowl', 'nord', 'onedark', 'palenight', 'rosepine', 'solarized', 'tokyonight', 'vitesse',
  // OS
  'android', 'amiga', 'atari', 'blackberry', 'beos', 'chromeos', 'c64', 'gnome', 'haiku', 'hpux', 'ios', 'kde', 'aqua', 'macos9', 'mint', 'morphos', 'msdos', 'nextstep', 'openstep', 'os2', 'palmos', 'plan9', 'reactos', 'redhat', 'riscos', 'sailfish', 'solaris', 'symbian', 'templeos', 'tizen', 'tos', 'irix', 'ubuntu', 'webos', 'win10', 'win31', 'win95', 'vista', 'windowsphone', 'winxp', 'zxspectrum',
  // Vibes
  'brutalist', 'cottagecore', 'cyberpunk', 'highcontrast', 'noir', 'paper', 'pastel', 'retrowave', 'solarpunk', 'steampunk', 'synthwave', 'terminal', 'vaporwave', 'y2k',
];
