...
export const THEME_NAMES: ThemeName[] = [
  ...
  // Editor Themes
  'ayu', 'catppuccin', 'dracula', 'everforest', 'gruvbox', 'kanagawa', 'monokai', 'nord', 'onedark', 'rosepine', 'solarized', 'tokyonight',
  // OS
  'android', 'amiga', 'atari', 'beos', 'chromeos', 'c64', 'gnome', 'haiku', 'ios', 'kde', 'aqua', 'macos9', 'mint', 'sonoma', 'msdos', 'nextstep', 'os2', 'palmos', 'plan9', 'redhat', 'solaris', 'symbian', 'templeos', 'tos', 'irix', 'ubuntu', 'win10', 'win31', 'win95', 'vista', 'winxp', 'zxspectrum',
  // Vibes
  'brutalist', 'cottagecore', 'cyberpunk', 'highcontrast', 'paper', 'retrowave', 'synthwave', 'terminal', 'vaporwave',
];
